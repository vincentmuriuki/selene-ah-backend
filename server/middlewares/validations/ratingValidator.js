...
class RatingValidator {
  ...
  static async validateArticleId(req, res, next){
    ...
    const articleExists = await validationHelper.existsInTable(
  ...
  static async checkIfArticleIsRated(req, res, next){
    const { articleId } = req.params;
    const articleIsRated = await validationHelper.existsInTable(
      Rating, { articleId }
      );
  ...
  static async checkIfOwnerWantsToRate(req, res, next){
    ...
    const articleBelongsToLoggedInUser = await validationHelper.existsInTable(
